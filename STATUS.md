...
**Статус:** Бэкенд полностью готов. Фронтенд — базовый дашборд готов, детальные страницы ещё нет.
...
| Детальная карточка актива (7 gauge-баров) | ❌ |
...
4. **Asset Detail страница** — клик на актив → 7 gauge-баров + NL объяснения
